...
pkgdatadir = $(datadir)/apertium-kha
pkgincludedir = $(includedir)/apertium-kha
pkglibdir = $(libdir)/apertium-kha
pkglibexecdir = $(libexecdir)/apertium-kha
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/apertium-kha.pc.in COPYING install-sh missing
...
CONFIG_CLEAN_FILES = apertium-kha.pc
...
am__installdirs = "$(DESTDIR)$(apertium_khadir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_kha_DATA) $(noinst_DATA) $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/missing autoconf
AUTOHEADER = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/missing autoheader
AUTOMAKE = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Khasi\" -DPACKAGE_TARNAME=\"apertium-kha\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Khasi\ 0.1.0\" -DPACKAGE_BUGREPORT=\"apertium-stuff@lists.sourceforge.net\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-kha\" -DPACKAGE=\"apertium-kha\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-kha
PACKAGE_BUGREPORT = apertium-stuff@lists.sourceforge.net
PACKAGE_NAME = Apertium Khasi
PACKAGE_STRING = Apertium Khasi 0.1.0
PACKAGE_TARNAME = apertium-kha
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-kha
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/swatstudent/Source/Khasi_Transducer
abs_srcdir = /home/swatstudent/Source/Khasi_Transducer
abs_top_builddir = /home/swatstudent/Source/Khasi_Transducer
abs_top_srcdir = /home/swatstudent/Source/Khasi_Transducer
am__leading_dot = .
...
install_sh = ${SHELL} /home/swatstudent/Source/Khasi_Transducer/install-sh
...
###############################################################################
#
#   apertium_kha_dir: This is where the compiled binaries go
#   apertium_kha_srcdir: This is where the source files go
apertium_khadir = $(prefix)/share/apertium/$(BASENAME)/
apertium_kha_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_kha_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS) $(LANG1).prob
...
$(am__aclocal_m4_deps):
apertium-kha.pc: $(top_builddir)/config.status $(srcdir)/apertium-kha.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_khaDATA: $(apertium_kha_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kha_DATA)'; test -n "$(apertium_khadir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_khadir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_khadir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_khadir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_khadir)" || exit $$?; \
	done

uninstall-apertium_khaDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kha_DATA)'; test -n "$(apertium_khadir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_khadir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_khadir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_khaDATA install-data-local \
...
uninstall-am: uninstall-apertium_khaDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_khaDATA install-data \
	...
	uninstall-am uninstall-apertium_khaDATA \
	uninstall-pkgconfigDATA
...
.deps/$(LANG1).LR.hfst: .deps/$(LANG1).LR.lexc-twoc.hfst .deps/$(LANG1).twol.hfst
	hfst-compose-intersect -1 .deps/$(LANG1).LR.lexc-twoc.hfst -2 .deps/$(LANG1).twol.hfst -o $@
...
$(LANG1).autogen.att.gz: .deps/$(LANG1).RL.hfst
	hfst-minimise $< | hfst-fst2txt | gzip -9 -c -n > $@
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_kha_srcdir) || mkdir -p $(DESTDIR)$(apertium_kha_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_kha_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_kha_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_kha_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_kha_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . kha-morph | tee .test-mt
